/* @ts-self-types="./actualised_core_wasm.d.ts" */

export class OrchestratorWasm {
    static __wrap(ptr) {
        const obj = Object.create(OrchestratorWasm.prototype);
        obj.__wbg_ptr = ptr;
        OrchestratorWasmFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        OrchestratorWasmFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_orchestratorwasm_free(ptr, 0);
    }
    /**
     * @param {any} agent_json
     * @returns {Promise<void>}
     */
    add_agent(agent_json) {
        const ret = wasm.orchestratorwasm_add_agent(this.__wbg_ptr, agent_json);
        return ret;
    }
    /**
     * @param {any} project_json
     * @returns {Promise<void>}
     */
    add_project(project_json) {
        const ret = wasm.orchestratorwasm_add_project(this.__wbg_ptr, project_json);
        return ret;
    }
    /**
     * @param {any} file_json
     ...
     */
    add_tool(tool_json) {
        const ret = wasm.orchestratorwasm_add_tool(this.__wbg_ptr, tool_json);
        return ret;
    }
    /**
     * @param {any} config_json
     */
    configure_inference(config_json) {
        const ret = wasm.orchestratorwasm_configure_inference(this.__wbg_ptr, config_json);
        if (ret[1]) {
     ...
     * @param {any} config_json
     */
    configure_rate_limits(config_json) {
        const ret = wasm.orchestratorwasm_configure_rate_limits(this.__wbg_ptr, config_json);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    found_company(name) {
        ...
        const ret = wasm.orchestratorwasm_found_company(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
    ...
    get_agent_context(agent_id) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.orchestratorwasm_get_agent_context(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
     ...
     * @returns {any}
     */
    get_agent_memories(agent_id) {
        const ptr0 = passStringToWasm0(agent_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.orchestratorwasm_get_agent_memories(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    get_agent_memory_tree(agent_id) {
        const ptr0 = passStringToWasm0(agent_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.orchestratorwasm_get_agent_memory_tree(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_agents() {
        const ret = wasm.orchestratorwasm_get_agents(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_company_name() {
        const ret = wasm.orchestratorwasm_get_company_name(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
     ...
     */
    get_projects() {
        const ret = wasm.orchestratorwasm_get_projects(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_shared_files() {
        const ret = wasm.orchestratorwasm_get_shared_files(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_shared_tree() {
        const ret = wasm.orchestratorwasm_get_shared_tree(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_tools() {
        const ret = wasm.orchestratorwasm_get_tools(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    /**
     * @returns {Promise<OrchestratorWasm>}
     */
    static init() {
        const ret = wasm.orchestratorwasm_init();
        return ret;
    }
    /**
     * @param {string} id
    ...
    remove_agent(id) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.orchestratorwasm_remove_agent(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @param {string} id
    ...
    remove_tool(name) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.orchestratorwasm_remove_tool(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @returns {Promise<void>}
     */
    run_orchestrator() {
        const ret = wasm.orchestratorwasm_run_orchestrator(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {string} agent_id
    ...
    send_agent_message(agent_id, message) {
        ...
        const ret = wasm.orchestratorwasm_send_agent_message(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
    /**
     * @param {string} id
     ...
     * @returns {Promise<void>}
     */
    update_tool(name, tool_json) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.orchestratorwasm_update_tool(this.__wbg_ptr, ptr0, len0, tool_json);
        return ret;
    }
}
if (Symbol.dispose) OrchestratorWasm.prototype[Symbol.dispose] = OrchestratorWasm.prototype.free;
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_6f8b0d724fe26c07: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen_d05406a4d4dc2481___convert__closures_____invoke___js_sys_5b72c82c83b45550___Function_fn_wasm_bindgen_d05406a4d4dc2481___JsValue_____wasm_bindgen_d05406a4d4dc2481___sys__Undefined___js_sys_5b72c82c83b45550___Function_fn_wasm_bindgen_d05406a4d4dc2481___JsValue_____wasm_bindgen_d05406a4d4dc2481___sys__Undefined_______true_(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbg_orchestratorwasm_new: function(arg0) {
            const ret = OrchestratorWasm.__wrap(arg0);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./actualised_core_wasm_bg.js": import0,
    };
}

function wasm_bindgen_d05406a4d4dc2481___convert__closures_____invoke_______true_(arg0, arg1) {
    wasm.wasm_bindgen_d05406a4d4dc2481___convert__closures_____invoke_______true_(arg0, arg1);
}
...
function wasm_bindgen_d05406a4d4dc2481___convert__closures_____invoke___js_sys_5b72c82c83b45550___Function_fn_wasm_bindgen_d05406a4d4dc2481___JsValue_____wasm_bindgen_d05406a4d4dc2481___sys__Undefined___js_sys_5b72c82c83b45550___Function_fn_wasm_bindgen_d05406a4d4dc2481___JsValue_____wasm_bindgen_d05406a4d4dc2481___sys__Undefined_______true_(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen_d05406a4d4dc2481___convert__closures_____invoke___js_sys_5b72c82c83b45550___Function_fn_wasm_bindgen_d05406a4d4dc2481___JsValue_____wasm_bindgen_d05406a4d4dc2481___sys__Undefined___js_sys_5b72c82c83b45550___Function_fn_wasm_bindgen_d05406a4d4dc2481___JsValue_____wasm_bindgen_d05406a4d4dc2481___sys__Undefined_______true_(arg0, arg1, arg2, arg3);
}
...
const OrchestratorWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_orchestratorwasm_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('actualised_core_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
